...
// 여정 스타일 비자 진단 입력 페이지 / Journey-style visa diagnosis input page
export default function JourneyDiagnosisPage() {
  ...
  const handleNext = () => {
    if (currentStep < totalSteps) {
      ...
      // 모든 단계 완료 - 출발 애니메이션 후 결과 페이지로 / All steps complete - departure animation then navigate to result
      setIsDeparting(true);
      setTimeout(() => {
        ...
        <Card className="relative border-2 border-dashed border-blue-400 bg-white shadow-xl overflow-hidden">
          ...
          <div className="p-6">
            ...
            <div className="flex gap-3 mt-6">
              ...
              >
                {currentStep === totalSteps ? '✈️ 출발하기' : '다음'}
              </Button>
            </div>
          </div>
        </Card>
