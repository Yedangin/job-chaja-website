 ...
 * 인증 상태 CTA + 요약 카드 + 빠른 액션 + 최근 공고 + 추천 인재
 */
export default function CompanyDashboardPage() {
  ...
  const summaryCards = [
    ...
    { icon: Ticket, label: '쿠폰', value: String(data.couponCount), href: '/company/mypage', color: 'orange' },
  ];
  ...
  const VerificationCTA = () => {
    ...
    if (verificationStatus === 'SUBMITTED') {
      return (
        <div className="bg-gradient-to-r from-yellow-50 to-orange-50 rounded-xl border border-yellow-200 p-5 mb-6">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              {/* 3단계 프로그레스 바 / 3-step progress bar */}
    ...
    if (verificationStatus === 'REJECTED') {
      return (
        <div className="bg-gradient-to-r from-red-50 to-pink-50 rounded-xl border border-red-200 p-5 mb-6">
          <div className="flex items-start gap-4">
    ...
    // NONE or PENDING (미제출) / Not yet submitted
    return (
