...
/**
 * 비자 플래너 API 프록시 — /api/visa-planner/* → /visa-planner/*
 * Visa planner API proxy — /api/visa-planner/* → /visa-planner/*
 */
async function proxyRequest(
  ...
  const url = `${BACKEND_URL}/visa-planner/${path.join('/')}${search}`;
  ...
  try {
    ...
    console.error(`[Proxy VisaPlanner ${method}] Error:`, error);
