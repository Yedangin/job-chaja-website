...
const hubSections: HubSection[] = [
  {
    title: '한국 생활 가이드',
    items: [
      { label: '외국인등록증 만들기', href: '/guide/1' },
      { label: '은행 계좌 개설 방법', href: '/guide/2' },
      { label: '건강보험 가입 안내', href: '/guide/4' },
      { label: '주거·교통 가이드', href: '/guide' },
    ],
  },
  {
    title: '비자별 취업 가이드',
    items: [
      { label: 'E-9 비전문취업 절차', href: '/guide', tag: '인기' },
      { label: 'H-2 방문취업 안내', href: '/guide' },
      { label: 'F-2 거주자격 변경', href: '/guide' },
      { label: 'E-7 전문직 비자', href: '/guide' },
    ],
  },
  {
    title: '어학 정보',
    items: [
      { label: 'TOPIK 시험 일정·접수', href: '/notice', tag: '시험' },
      { label: '세종학당 찾기', href: '/guide' },
      { label: '무료 한국어 온라인 강좌', href: '/guide/5' },
      { label: '어학당 모집 공고', href: '/notice' },
    ],
  },
  {
    title: '근로자 권리',
    items: [
      { label: '2026년 최저임금 안내', href: '/guide', tag: '최신' },
      { label: '노동법 기본 상식', href: '/guide' },
      { label: '부당대우 신고 방법', href: '/guide' },
      { label: '무료 상담 전화번호', href: '/guide' },
    ],
  },
  {
    title: '정책 변경 알림',
    items: [
      { label: '2026년 E-9 쿼터 변경', href: '/notice' },
      { label: 'H-2 체류기간 연장 안내', href: '/notice' },
      { label: '외국인 고용허가제 개정', href: '/notice' },
    ],
  },
  {
    title: '공지사항',
    items: [
      { label: '잡차자 서비스 오픈 안내', href: '/notice' },
      { label: '비자 진단 서비스 출시', href: '/notice' },
      { label: '기업 회원 모집 중', href: '/notice' },
    ],
  },
];
