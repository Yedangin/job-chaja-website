const en = {
  ...
  createSub: 'Please enter accurate information for secure service use.',

  labelName: 'Full name (passport / English name recommended)',
  ...
  term1: '[Required] Agree to Terms of Service',
  term2: '[Required] Agree to collection and use of personal information',
  term3: '[Required] Agree to overseas transfer and third-party sharing of personal information',
  term4: '[Optional] Agree to receive marketing information',
  ...
  review2Text: 'I found a visa sponsor at a startup.',
  review2Author: 'Sarah, D-10 Job Seeker',

  review3Text: 'It became much easier to find talent who can communicate in Korean!',
